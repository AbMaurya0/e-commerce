...
import 'package:shop/features/authentication/controllers/createuserform_controller.dart';

import '../authentication_repository/authentication_repository.dart';
import '../model_provider/user_model.dart';

class CreateUserform extends StatelessWidget {
  CreateUserform({super.key});

  final signControl = Get.put(createuserformController());
                            ...
                            onPressed: () {
                              if (_formkey.currentState!.validate()) {
                                final user = UserModel(
                                    name:
                                        signControl.namecontroller.text.trim(),
                                    email:
                                        signControl.emailcontroller.text.trim(),
                                    password: signControl
                                        .passwordcontroller.text
                                        .trim(),
                                    phone: signControl.phonenocontroller.text
                                        .trim());
                                AuthenticationRepo.instance.createUser(user);
                                Get.to(const ProductOverviewScreen());
                              }
                            },
                            child: Padding(
